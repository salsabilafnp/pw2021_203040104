...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 28, 2021 at 01:27 AM
...
(5, 'grey-orange.jpg', 'trilay pastel', 'High-sneakers for hangout and casual-look. The available colors is only grey-purple (same as on picture).', 'Rp 379k', 'Casual'),
(6, 'orange.jpg', 'airy casual', 'Runshoes for men and women. The available colors are white-orange and blak-red.', 'Rp 279k', 'Runshoes'),
...
(2, 'salsabilafnp', '$2y$10$zM1XoyaEb7oCmhM2CnSYEugf0HXHxPB/B3CZBFyU6U5euA8ELc8F6');
